...
function loadQuestions() {
    ...
    questions.push(new Question("What is the name of the French national anthem?", 2, "La Vie en Rose", "The Star Spangled Banner", "La Marsaillaise", "God Save the Queen"));
